...
local tunnel = {} --singleton class instance
...
function TCell.init()
  ...
  imgTunnel = apiG.newImage('images//tunnel01.png') 
  ...
  -- singletons  
  tunnel = TCell.newCell()
  tunnel.type = 'tunnel'
  tunnel.pass = true
  tunnel.img = imgTunnel
  tunnel.antMaxSpeed = 1.8 * cfg.antMaxSpeed
  function tunnel.affectAnt( ant )
    ant.maxSpeed = tunnel.antMaxSpeed
  end 
end
--- child class food
...
--- child class tunnel - singleton
function TCell.newTunnel()
  return tunnel
end
